/**
 * @fileoverview Database API endpoints router
 * @packageDocumentation
 */

import { NetlifyRouter, createErrorResponse, json } from 'netlify-api-framework'
import { getDatabaseService } from '../../../src/services/databaseService.js'

/**
 * Creates and configures database API router with CRUD operations
 * @returns {NetlifyRouter} Configured database router
 */
export function createDatabaseRouter(): NetlifyRouter {
